$(document).ready(function (){
    ...
    function clickedFieldTwoPlayer(){
	...
	function restart(winnerLast){
		...
		//if loser starts first
		if (!winnerLast) controlNumber = 0;

		//if single player game and player wins cpu should start
		if (winnerLast && cpuGame && controlNumber === 1) {
            cpuMove();
		}

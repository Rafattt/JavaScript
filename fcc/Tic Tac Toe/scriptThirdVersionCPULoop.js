$(document).ready(function (){
	...
	var clickedFieldSinglePlayer = $('.fields').click(function(event){	//checking which field was clicked and getting id of this field
		var field = event.target.id;
		...
		if(controlNumber === 0){
			...
			}while(combinedResults.indexOf(ff) != -1);
			controlNumber = 0;
		}
		fieldsClicked++;	//increment number of field clicked
